...
void CWinEventEditor::push(const std::string str, const int id)
{
	push(str, id, m_cpair);
}
void CWinEventEditor::push(const std::string str, const int id, const int cpair)
{
...
void CWinEventEditor::change(const std::string str, const int id, const int index)
{
	m_list[index] = str;
	m_index[index] = id;
