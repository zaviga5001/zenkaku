#ifndef CWINWEAPONEDITOR_H
#define CWINWEAPONEDITOR_H
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <unistd.h>
...
class CWinWeaponEditor : public CWindows
{
public:
	CWinWeaponEditor(CData* data, CConfig* config, CFile* file);
	virtual ~CWinWeaponEditor();
	...
	void            read_weapon_list();       // アイテム名のみ読み込み
	void		read_weapon(int index);	// アイテム読み込み
	void		write_weapon(int index);	// アイテム書き込み
